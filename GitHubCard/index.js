...
axios.get("https://api.github.com/users/AndrewMaddocks").then(response => {
  ...
  const cardsInfo = cardCreator(response.data);
...
function cardCreator(arg) {
  ...
  profileLink.textContent = "Profile:  " + arg.url;
  followers1.textContent = "Followers:  " + arg.followers;
  following1.textContent = "Followers:  " + arg.following;
  bio1.textContent = "Bio:  " + arg.bio;
